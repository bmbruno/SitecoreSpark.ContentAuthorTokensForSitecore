...
namespace SitecoreSpark.CATS.Validators
{
    ...
    public class NoDuplicateTokens : StandardValidator
    {
        ...
        protected override ValidatorResult Evaluate()
        {
            ...
            IEnumerable<Token> tokens = TokenManager.GetTokensFromLibraries(libraries);

            // Check for duplicate key
            if (tokens.Any(u => u.Pattern.Equals(inputValue, StringComparison.InvariantCultureIgnoreCase)))
            {
